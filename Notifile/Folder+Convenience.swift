...
extension Folder {
    ...
    @discardableResult convenience init(url: URL, observationType: ObservationType, isObserving: Bool, files: [URL] = [], context: NSManagedObjectContext = CoreDataStack.context) {
